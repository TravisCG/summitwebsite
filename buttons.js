...
//this part help us trim the dots with the trimming button
var trimmedarray = ["CTCF"];

function trimthemall(){
trimmedarray = ujtomb;
var totrim = '.' + trimmedarray.join(' .');

};

var totrim = '.' + trimmedarray.join(' .');
$(document).ready(function(){
    $("#trimdotz").click(function(){
        $('.' + trimmedarray.join(' .')).fadeOut("slow");
    });
});
