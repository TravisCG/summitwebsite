...
<!--topdiv -->
  ...
  <div class="foo">
    <ul class="navlink">
        ...
        <li><a href="about.html" title="Tools">Tools</a>
          <ul class="subnav">
                <li><a  href="motif_view.php"><button>Motif view</button></a></li>
                <li><button>Pairshift view</button></li>
                <li><button>Jbrowser view</button></li>
        </ul></li>
	...
	<?php echo " <h4 style='text-align: center;margin-left: 12em;'>	The experiments shown here are the ". $motiveName . " consensus motive.</h4><br>" ?>
