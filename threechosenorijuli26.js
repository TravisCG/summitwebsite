...
.html(function(d) { return "<div style=\"height:7em;padding:0.4em;font-size:0.7em;\">You flagged the following experiments (cell line, antibody, element number): <br/> The blue buttons will help navigating to the other views.<br>Click on the buttons to open <br> the \'experiment view\' for more details <br>about the Chip-seq data. </div>"})
